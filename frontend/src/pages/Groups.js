...
export default function GroupDetail() {
  ...
  if (!group)
    return <div className="p-10 text-center text-gray-500 dark:text-gray-300">Loading...</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 px-4 py-6 sm:px-8 transition flex justify-center">
      <div className="w-full max-w-4xl space-y-10">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 border dark:border-gray-700">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">👥 Members</h2>

          <ul className="mb-5 space-y-2">
            {group.members.map((m) => (
              <li key={m.id} className="text-lg">{m.name}</li>
            ))}
          </ul>
          ...
          <form onSubmit={addMember} className="flex flex-col sm:flex-row gap-3">
            ...
            <button className="bg-green-600 dark:bg-green-500 text-white px-5 py-2 rounded-lg shadow">
              Add
            </button>
          </form>
        </div>
        ...
        {/* ADD EXPENSE */}
        <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 border dark:border-gray-700">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">💰 Add Expense</h2>
          ...
          <button
            onClick={addExpense}
            className="mt-4 w-full sm:w-auto bg-blue-600 dark:bg-blue-500 text-white px-6 py-2 rounded-lg shadow"
          >
            Add Expense
          </button>
        </div>
